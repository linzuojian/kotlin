 ...
 * (nullability, availability, bridging, etc.) is intentionally dropped: those belong to Clang's semantic-analysis
 * phase, and applying them here would reshape the generated interface in ways this feature is not meant to touch.
 *
...
class ApiNotes private constructor(
    ...
    val isEmpty: Boolean
        get() = classes.isEmpty() && protocols.isEmpty()
    ...
    companion object {
        val EMPTY = ApiNotes(emptyMap(), emptyMap())
         ...
         *
         * Header-based (non-modular) interop is not covered yet; such libraries produce [EMPTY].
         */
        fun load(library: NativeLibrary): ApiNotes {
            ...
            val result = ApiNotes(classes, protocols)
