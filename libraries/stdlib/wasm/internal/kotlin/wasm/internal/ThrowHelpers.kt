...
private const val INITIALIZATION_STATE_INITIALIZED: Byte = 1
private const val INITIALIZATION_STATE_ERROR: Byte = 2

@UsedFromCompilerGeneratedCode
internal fun checkStaticInitializationState(state: Byte, klass: KClass<*>?): Boolean {
