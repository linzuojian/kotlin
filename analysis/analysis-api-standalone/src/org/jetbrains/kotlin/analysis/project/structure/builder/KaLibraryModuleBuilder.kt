...
import org.jetbrains.kotlin.analysis.api.standalone.projectStructure.toLibraryScopeConstructionMode
    ...
    override fun build(): KaLibraryModule {
        ...
        val contentScope = contentScope
            ?: StandaloneProjectFactory.createLibraryModuleSearchScope(
                binaryRoots,
                binaryVirtualFiles,
                libraryScopeConstructionMode.toLibraryScopeConstructionMode(),
